import { BinaryBoard, BinaryPiece, white } from "./binaryBoard";
...
// export const togglePlayerTurn = (state: BinaryBoard): void => {
//     const a = state.current.split(' ')
//     let b = a[1]
//     b = b === 'w' ? 'b' : 'w'
//     a[1] = b
...
export const getPiece = (state: BinaryBoard, pos: Pos): BinaryPiece => {
    ...
    // const color = rank[pos.file] & white ? Color.white : Color.black
    // return new BinaryPie
    // return new Piece(rank[pos.file], pos.y, pos.x, color)
}

// export const getRank = (state: BinaryBoard, rank: string): string => {
